...
Shader "Custom/Wireframe"
{
	Properties
	{
		...
		_WireWidth("WireWidth",Range(1,100)) = 10
		_WireBGColor("WireBGColor", Color) = (1,1,1,1)
	}
	...
	half4 frag(g2f IN) : COLOR
	{
		...
		float I = exp2(-4.0*d*d/_WireWidth);

	return lerp(_WireBGColor, _WireColor, I);
	}
